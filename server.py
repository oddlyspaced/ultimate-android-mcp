...
def input_keyevent(keycode: int):
    """Simulates a key event with the specified keycode on the connected Android device."""
...
def input_press(keycode: int):
    """Simulates a key press event with the specified keycode on the connected Android device."""
...
def input_roll(dx: int, dy: int):
    """Simulates a rolling gesture with the specified dx and dy values on the connected Android device."""
...
def input_swipe(x1: int, y1: int, x2: int, y2: int, duration_ms: int = None):
    """Simulates a swipe gesture from (x1, y1) to (x2, y2) with an optional duration on the connected Android device."""
...
@mcp.tool()
def cpu_count():
    """Returns the number of CPU cores on the connected Android device."""
...
@mcp.tool()
def cpu_percent():
    """Returns the current CPU load percentage on the connected Android device."""
...
@mcp.tool()
def get_serial_no():
    """Returns the serial number of the connected Android device."""
...
@mcp.tool()
def get_properties():
    """Returns the build.prop properties of the connected Android device."""
...
@mcp.tool()
def list_features():
    """Returns the device overlay configuration properties of the connected Android device."""
...
def get_battery_level():
    """Returns the battery level of the connected Android device."""
...
@mcp.tool()
def wm_density():
    """Returns the screen density of the connected Android device."""
...
@mcp.tool()
def wm_size():
    """Returns the screen size of the connected Android device."""
...
def pull_file(remote: str, local: str):
    """Pulls a file from the connected Android device to the local machine."""
...
def push_file(local: str, remote: str):
    """Pushes a file from the local machine to the connected Android device."""
...
def get_pid(package_name: str):
    """Returns the process ID (PID) for the specified package name on the connected Android device."""
...
def get_top_activities():
    """Returns the activities currently on top on the connected Android device."""
...
def get_top_activity():
    """Returns the singular activity currently on top on the connected Android device."""
...
def is_installed(package_name: str):
    """Checks if the specified package is installed on the connected Android device."""
...
def get_all_packages(
    ...
    """Returns a list of all packages on the connected Android device, with optional filters for user-installed or system-installed packages."""
...
def get_system_packages():
    """Returns a list of system-installed packages on the connected Android device."""
    return handler.get_system_packages()
...
def get_user_packages():
    """Returns a list of user-installed packages on the connected Android device."""
    return handler.get_user_packages()
...
def launch_app(package_name: str):
    """Launches the specified app on the connected Android device."""
